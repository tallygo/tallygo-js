...
describe('Request', () => {
  ...
  describe('get', () => {
    ...
    it('uses default values for parameters', async () => {
      const realDateNow = Date.now.bind(global.Date)
      const dateNowStub = jest.fn(() => 1544601278248)
      ...
      expect(fetch).toHaveBeenCalledWith(
        'https://api.example.com/v1/route?apiKey=fakeApiKey&' +
        'coords=34.76151710977818%2C-112.0571484988772%3B34.76260434283671%2C-112.01666952034871&' +
        'requestType=DepartureTime&startPoint=34.76151710977818%2C-112.0571484988772&' +
        'endPoint=34.76260434283671%2C-112.01666952034871&course=0&speed=0&' +
        'time=2018-12-12T07%3A54%3A38Z&useCarpoolLanes=false&useExpressLanes=false'
      )
